...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.7]{kladde_ide.png}
...
Spillet er inspireret af \textit{Space Invaders}. Idéen med spillet er, at du spiller en drage som skyder efter kattene, der kommer ind fra siden, hvor en dødsanimation dukker op når en kat er ramt. Spilleren taber hvis dragen bliver ramt/rammer en af kattene. Spilleren vinder forsåvidt ikke, men får derimod to score. En for tid for overlevelse og en for hvor mange katte der er blevet \textit{poppet}.
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.6]{kladde_spil.png}
